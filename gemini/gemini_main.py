...
def main():
    ...
    parser_load.add_argument('--cores', dest='cores', default=1, type=int,
                             help="Number of cores to use to load in parallel.")
    parser_load.add_argument('--lsf-queue', dest='lsf_queue',
    ...
    parser_query.add_argument('--gt-filter', dest='gt_filter', metavar='STRING',
