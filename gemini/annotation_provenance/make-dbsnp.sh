...
curl ftp://ftp.ncbi.nih.gov/snp/organisms/human_9606_b141_GRCh37p13/VCF/All.vcf.gz > dbsnp.b141.vcf.gz
gunzip dbsnp.b141.vcf.gz | bgzip -c > dbsnp.b141.hg19.vcf.gz
tabix -p vcf dbsnp.b141.hg19.vcf.gz